...
jsdomDescribe('vdom', () => {
	...
	describe('children', () => {
		...
		it('Can update, insert and remove only affected nodes from widgets', () => {
			...
			assert.lengthOf(root.childNodes, 16);
			assert.strictEqual(root.childNodes[0], childOne);
			assert.strictEqual(root.childNodes[0].childNodes, childOne.childNodes);
			assert.strictEqual(root.childNodes[1], childEight);
			assert.strictEqual(root.childNodes[1].childNodes, childEight.childNodes);
			assert.strictEqual(root.childNodes[2], childNine);
			assert.strictEqual(root.childNodes[2].childNodes, childNine.childNodes);
			assert.strictEqual(root.childNodes[3], childTen);
			assert.strictEqual(root.childNodes[3].childNodes, childTen.childNodes);
			assert.strictEqual(root.childNodes[4], childSix);
			assert.strictEqual(root.childNodes[4].childNodes, childSix.childNodes);
			assert.strictEqual(root.childNodes[9], childSeven);
			assert.strictEqual(root.childNodes[9].childNodes, childSeven.childNodes);
			assert.strictEqual(root.childNodes[10], childTwo);
			assert.strictEqual(root.childNodes[10].childNodes, childTwo.childNodes);
			assert.strictEqual(root.childNodes[11], childThree);
			assert.strictEqual(root.childNodes[11].childNodes, childThree.childNodes);
			assert.strictEqual(root.childNodes[12], childFour);
			assert.strictEqual(root.childNodes[12].childNodes, childFour.childNodes);
			assert.strictEqual(root.childNodes[13], childEleven);
			assert.strictEqual(root.childNodes[13].childNodes, childEleven.childNodes);
			assert.strictEqual(root.childNodes[14], childTwelve);
			assert.strictEqual(root.childNodes[14].childNodes, childTwelve.childNodes);
