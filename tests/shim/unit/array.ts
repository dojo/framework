...
registerSuite('array', {
	...
	'#findIndex()': createNativeAndDojoArrayTests('es6-array', (function () {
	...
	'#find()': createNativeAndDojoArrayTests('es6-array', (function () {
	...
	'#includes': createNativeAndDojoArrayTests('es7-array', (function() {
		let arr: number[];
		return {
			beforeEach() {
				arr = [ 1, 2, NaN, 3, 4, 5 ];
